#include <memory>
// 类似python的from nav2_simple_commander.robot_navigator import RobotNavigator
...
public:
    ...
    void sendGoal()
    {
        ...
        goal_msg.pose.pose.position.x = 2.1f;    // 设置目标点的x坐标为2.1
        goal_msg.pose.pose.position.y = 1.2f;    // 设置目标点的y坐标为1.2
